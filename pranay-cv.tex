...
\cvline{}{I am interested in using theoretical and computational chemical physics tools to model disordered materials and developing the next generation of semiconductor optoelectronic devices.}
...
\cventry{2023--2024}{Visiting Research Student}{Frost Group, Imperial College London}{London, England}{}{
    Mentor: Professor Jarvist Moore Frost at Department of Chemistry, Imperial College London.
    \begin{itemize}
        \item Developed Non-Adiabatic dynamics methods for semiconductor materials to simulate the time-dependent electronic structure of materials under photoexcitation.
    \end{itemize}
}
...
\cvline{1}{Sukanya Das, \textbf{Pranay Venkatesh}, Sarbani Ghosh, K S Narayan. Ordered and Disordered Microstructures of Nanoconfined Conducting Polymers, RSC Soft Matter 2023}
...
\cventry{April 2020}{Online High School Chemistry Classses}{NPS International, Chennai}{}{}{
    \begin{itemize}
        \item Taught online video classes on solution chemistry for Grade 12 during COVID in NPS International Chennai
    \end{itemize}
}
