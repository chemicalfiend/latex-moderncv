...
\cventry{2023--2024}{Imperial College London}{Dept of Chemistry}{London, England}{}{
    ...
    \begin{itemize}
        \item Worked on using Path Integral Quantum Dynamics methods to understand the time-dependent electronic structure of materials under photoexcitation.
        \item Developed workflows for applying these methods to simulate polarons in organic materials.
    \end{itemize}
}
...
\cventry{}{Other Hobbies}{}{}{}{
    Cricket; Philosophy; Cryptic Crossword; DIY Electronics}
